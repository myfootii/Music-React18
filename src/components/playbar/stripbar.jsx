                ...
                curSongInfo && (
                    <div className={sty.paly_bar}>
                        <Slider 
                            ...
                            styles={{track: {background: '#c7332f'}}} 
                            dotSize={2}
                            />
                            ...
                            <div className={sty.bar_r}>
                                <div className={sty.bar_oper}>
                                    <div className={sty.volume_main}>
                                        ...
                                        <Slider min={0} max={1} step={0.01} styles={{track: {background: '#c7332f'}}} className={sty.volume_line} value={volumeProgressWidth} onChange={setVolumeProgress} tooltip={{ formatter: null }} />
                                    </div>
